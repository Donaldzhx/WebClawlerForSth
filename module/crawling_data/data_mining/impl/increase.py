...
from module.crawling_data.data_mining.impl.constants import number_per_millie
...
class RiseStrategy(DataCleaningStrategy):
    ...
    fund_3_years_increase_pattern = re.compile(fr'近3年[\s\S]*?({number_per_millie}%|---)')
    fund_5_years_increase_pattern = re.compile(fr'近5年[\s\S]*?({number_per_millie}%|---)')
